...
fn test_statement() {
    ...
    let cases = &[
        ...
        r#"CREATE MATERIALIZED VIEW mv AS SELECT a FROM t;"#,
        r#"CREATE SYNC MATERIALIZED VIEW mv AS SELECT a FROM t;"#,
        r#"CREATE ASYNC MATERIALIZED VIEW mv AS SELECT a FROM t;"#,
